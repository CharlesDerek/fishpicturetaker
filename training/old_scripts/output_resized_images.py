...
def add_jpeg_decoding(input_width, input_height, input_depth, input_mean,
  ...
  resized_image = tf.image.resize_bilinear(decoded_image_4d,
                                           resize_shape_as_int)
  resized_image_as_uint = tf.reshape(tf.cast(resized_image, dtype=tf.uint8), [input_width, input_height, input_depth])
  encoded_image = tf.image.encode_jpeg(resized_image_as_uint)
  return jpeg_data, encoded_image
...
def main(_):
  ...
  with tf.Session(graph=graph) as sess:
    ...
    image_paths = ['./data/0dfac3c520d734d1b58c94b5317d9d4b2bd0ca587714ebf28923507d9f6bb888.jpg', './data/2eeffc2821e97240bc86fdd66e9ddb632124a87f46667771927a8e9dc314cdc3.jpg', './data/75d7d8e9894161553997e3c4fe436f6271132938eb43594ed5b942c5a2d7488e.jpg', './data/e212e5fd3e5196c319f906d65f4ace7813db82eda0a17568fb877438c995cd72.jpg']
    i = 0
    for image_path in image_paths:
      ...
      resized_image_data = sess.run(decoded_image_tensor, feed_dict={jpeg_data_tensor: image_data})
      gfile.FastGFile("%s.jpg" % i, "wb").write(resized_image_data)
      i += 1
